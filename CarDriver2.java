...
**/
	...
	**/
	...
	public CarDriver2(String name) {
		this.name = name;
		if(this.name.equals("West Campus")){
			this.coord = new Coordinate(38.8327968, -77.3264524);
		}
		else if(this.name.equals("Lot A")) {
			this.coord = new Coordinate(38.82623, -77.307073);
		}
		else if(this.name.equals("Lot C")) {
			this.coord = new Coordinate(38.8252031, -77.3059246);
		}
		else if(this.name.equals("Lot I")) {
			this.coord = new Coordinate(38.83333, -77.3119133);
		}
		else if(this.name.equals("Lot J")) {
			this.coord = new Coordinate(38.8298081, -77.3147599);
		}
		else if(this.name.equals("Lot K")) {
			this.coord = new Coordinate(38.827806, -77.312655);
		}
		else if(this.name.equals("Lot L")) {
			this.coord = new Coordinate(38.8256766, -77.3106616);
		}
		else if(this.name.equals("Lot M")) {
			this.coord = new Coordinate(38.833843, -77.3136804);
		}
		else if(this.name.equals("Lot O")) {
			this.coord = new Coordinate(38.8344029, -77.3135063);
		}
		else if(this.name.equals("Lot P")) {
			this.coord = new Coordinate(38.8349269, -77.3163289);
		}
		else if(this.name.equals("Lot PV")) {
			this.coord = new Coordinate(38.8308986, -77.3142792);
		}
		else if(this.name.equals("Mason Pond Parking Deck")) {
			this.coord = new Coordinate(38.8304308, -77.3095572);
		}
		else if(this.name.equals("Rappahannock River Parking Deck")) {
			this.coord = new Coordinate(38.8346877, -77.3057672);
		}
		else if(this.name.equals("Shenandoah Parking Deck")) {
			this.coord = new Coordinate(38.828913, -77.3045308);
		}
		
		
		
		
		else if(this.name.equals("Aquatic And Fitness Center")) {
			this.coord = new Coordinate(38.8263722, -77.3042089);
		}
		else if(this.name.equals("Aquia Building")) {
			this.coord = new Coordinate(38.8320733, -77.3094103);
		}
		else if(this.name.equals("Art And Design Building")) {
			this.coord = new Coordinate(38.8279848, -77.306326);
		}
		else if(this.name.equals("Buchanan Hall")) {
			this.coord = new Coordinate(38.8287999, -77.3085567);
		}
		else if(this.name.equals("Carrow Hall")) {
			this.coord = new Coordinate(38.8314068, -77.3012546);
		}
		else if(this.name.equals("Carty House")) {
			this.coord = new Coordinate(38.8318161, -77.3190484);
		}
		else if(this.name.equals("Center For The Arts")) {
			this.coord = new Coordinate(38.8295271, -77.3093946);
		}
		else if(this.name.equals("Central Heating And Cooling Plant")) {
			this.coord = new Coordinate(38.8316552, -77.3027805);
		}
		else if(this.name.equals("Child Development Center")) {
			this.coord = new Coordinate(38.8356294, -77.3046541);
		}
		else if(this.name.equals("Clock")) {
			this.coord = new Coordinate(38.8309487, -77.3071432);
		}
		else if(this.name.equals("College Hall")) {
			this.coord = new Coordinate(38.8289205, -77.3079299);
		}
		else if(this.name.equals("Cross Cottage")) {
			this.coord = new Coordinate(38.8287348, -77.3109088);
		}
		else if(this.name.equals("David King Hall")) {
			this.coord = new Coordinate(38.8305973, -77.306685);
		}
		else if(this.name.equals("DeLaski Performing Arts Building")) {
			this.coord = new Coordinate(38.8298799, -77.3086084);
		}
		else if(this.name.equals("EagleBank Arena")) {
			this.coord = new Coordinate(38.8268068, -77.3096186);
		}
		else if(this.name.equals("East Building")) {
			this.coord = new Coordinate(38.8329812, -77.3082557); //est
		}
		else if(this.name.equals("Enterprise Hall")) {
			this.coord = new Coordinate(38.8289948, -77.3063708); //enterprise
		}
		else if(this.name.equals("Exploratory Hall")) {
			this.coord = new Coordinate(38.8296479, -77.3054928); //explo
		}
		else if(this.name.equals( "Facilities Administration")) {
			this.coord = new Coordinate(38.8323083, -77.3028703); //facitlit admin
		}
		else if(this.name.equals("Facilities Management Archives")) {
			this.coord = new Coordinate(38.8325621, -77.3015238); //facilities manadgem arch
		}
		else if(this.name.equals("Facilities Management Operations")) {
			this.coord = new Coordinate(38.8324935, -77.3022936); //fac man oper
		}
		else if(this.name.equals("Fenwick Library")) {
			this.coord = new Coordinate(38.832139, -77.307179); //fenwick
		}
		else if(this.name.equals("Field House And Module")) {
			this.coord = new Coordinate(38.8340515, -77.314834); //field house
		}
		else if(this.name.equals("Finley Building")) {
			this.coord = new Coordinate(38.8330503, -77.308884); //finley
		}
		else if(this.name.equals("George Mason Statue")) {
			this.coord = new Coordinate(38.8304222, -77.3083889); //gmu stat
		}
		else if(this.name.equals("Greenhouse")) {
			this.coord = new Coordinate(38.828022, -77.3013668); //greenhouse
		} 
		else if(this.name.equals("Harris Theatre")) {
			this.coord = new Coordinate(38.8309602, -77.30861); //harris
		} 
		else if(this.name.equals("Innovation Hall")) {
			this.coord = new Coordinate(38.8286144, -77.3074609); //innov
		} 
		else if(this.name.equals("Johnson Center")) {
			this.coord = new Coordinate(38.8297384, -77.3075063); //jc
		}
		else if(this.name.equals("Kelley II")) {
			this.coord = new Coordinate(38.8314262, -77.3180612); //kelley 2
		}
		else if(this.name.equals("Krasnow Institute")) {
			this.coord = new Coordinate(38.8311655, -77.3003744); //krasnow
		}
		else if(this.name.equals("Krug Hall")) {
			this.coord = new Coordinate(38.832448, -77.308525);  //krug
		}
		else if(this.name.equals("Lecture Hall")) {
			this.coord = new Coordinate(38.8331434, -77.3075377); //lec
		}
		else if(this.name.equals("Merten Hall")) {
			this.coord = new Coordinate(38.835053, -77.3079275);  //merten
		}
		else if(this.name.equals("Music Theater Building")) {
			this.coord = new Coordinate(38.829309, -77.3080905); //music thea  
		}
		else if(this.name.equals("Nguyen Engineering Building")) {
			this.coord = new Coordinate(38.8275249, -77.3050694);  //nguyen eng
		}
		else if(this.name.equals("Northeast Module")) {
			this.coord = new Coordinate(38.834537, -77.3041269);  //northeast module
		}
		else if(this.name.equals( "Northeast Module II")) {
			this.coord = new Coordinate(38.8340348, -77.3039474);  //northeast module 2
		}
		else if(this.name.equals("Nottoway Annex")) {
			this.coord = new Coordinate(38.8254484, -77.305563); //notto
		}
		else if(this.name.equals("Parking Services")) {
			this.coord = new Coordinate(38.828937, -77.3051142); //parking
		}
		else if(this.name.equals("Peterson Hall")) {
			this.coord = new Coordinate(38.8342542, -77.3090726); //peterson
		}
		else if(this.name.equals("Planetary Hall")) {
			this.coord = new Coordinate(38.8298814, -77.3062813); //planetary
		}
		else if(this.name.equals("Police and Safety Hdqrt")) {
			this.coord = new Coordinate(38.8353507, -77.3059358); //police
		}
		else if(this.name.equals("Recreation and Athletic Complex")) {
			this.coord = new Coordinate(38.8306443, -77.3124311); //recreat
		}
		else if(this.name.equals("Recycling Center")) {
			this.coord = new Coordinate(38.8325164, -77.3010222); //recyc
		}
		else if(this.name.equals( "Research Hall")) {
			this.coord = new Coordinate(38.8282768, -77.3052496); //research
		}
		else if(this.name.equals( "Rivanna Module")) {
			this.coord = new Coordinate(38.8325975, -77.3040371); //rivanna
		}
		else if(this.name.equals("Robert's House")) {
			this.coord = new Coordinate(38.8279111, -77.30003); //roberts
		}
		else if(this.name.equals("Robinson Hall B")) {
			this.coord = new Coordinate(38.8309161, -77.3081211); //robinsonB
		}
		else if(this.name.equals("Student Union Building I")) {
			this.coord = new Coordinate(38.8314495, -77.3092105); //SUB1
		}
		else if(this.name.equals("Theater Space")) {
			this.coord = new Coordinate(38.8298799, -77.3086084); //THeater space
		}
		else if(this.name.equals("The Hub")) {
			this.coord = new Coordinate(38.8308162, -77.305361); //HUb
		}
		else if(this.name.equals("Thompson Hall")) {
			this.coord = new Coordinate(38.8327461, -77.3099166); //thompson
		}
		else if(this.name.equals("Warehouse")) {
			this.coord = new Coordinate(38.831531, -77.3020175); //warehouse
		}
		else if(this.name.equals("West Building")) {
			this.coord = new Coordinate(38.8320677, -77.3094198); //west building
		}
		else if(this.name.equals( "West PE Module")) {
			this.coord = new Coordinate(38.8313306, -77.3144487); //west PE module
		}
		else if(this.name.equals("Blue Ridge")) {
			this.coord = new Coordinate(38.8329423, -77.3064297); //blue ridge
		}
		else if(this.name.equals("Eastern Shore")) {
			this.coord = new Coordinate(38.8334212, -77.3042167); //eastern shore
		}
		else if(this.name.equals("Hampton Roads")) {
			this.coord = new Coordinate(38.8338515, -77.305204); //hampton road
		}
		else if(this.name.equals("Northern Neck")) {
			this.coord = new Coordinate(38.8338116, -77.3070027); //nothern neck
		}
		else if(this.name.equals("Piedmont")) {
			this.coord = new Coordinate(38.8323999, -77.3064999); //piedmont
		}
		else if(this.name.equals("Sandbridge")) {
			this.coord = new Coordinate(38.8325012, -77.3064919); //sandbrd
		}
		else if(this.name.equals("Skyline Fitness Center")) {
			this.coord = new Coordinate(38.831626, -77.305845); //skyline 
		}
		else if(this.name.equals("Southside")) {
			this.coord = new Coordinate(38.8313068, -77.3055677); //southside 
		}
		else if(this.name.equals("Tidewater")) {
			this.coord = new Coordinate(38.831937, -77.3060324); //tidewater 
		}
		else if(this.name.equals("Commonwealth")) {
			this.coord = new Coordinate(38.8333874, -77.3061016); //commonwealth 
		}
		else if(this.name.equals("Dominion")) {
			this.coord = new Coordinate(38.8329459, -77.3057425); //dominon 
		}
		else if(this.name.equals("Amherst")) {
			this.coord = new Coordinate(38.8326056, -77.304833); //amherst 
		}
		else if(this.name.equals("Brunswick")) {
			this.coord = new Coordinate(38.8324417, -77.3045517);//bruns
		}
		else if(this.name.equals("Carroll")) {
			this.coord = new Coordinate(38.8319049, -77.3044507); //carrol
		}
		else if(this.name.equals("Dickenson")) {
			this.coord = new Coordinate(38.8316675, -77.3046504); //dickenson
		}
		else if(this.name.equals("Essex")) {
			this.coord = new Coordinate(38.8317925, -77.3050525); //essex
		}
		else if(this.name.equals("Franklin")) {
			this.coord = new Coordinate(38.8308613, -77.305988); //frannklin
		}
		else if(this.name.equals("Grayson")) {
			this.coord = new Coordinate(38.8308613, -77.305988); //grayson
		}
		else if(this.name.equals("Hanover")) {
			this.coord = new Coordinate(38.8321452, -77.3047789); //hanover
		}
		else if(this.name.equals("Liberty Square")) {
			this.coord = new Coordinate(38.827809, -77.3025014); //libsquar
		}
		else if(this.name.equals("Potomac Heights")) {
			this.coord = new Coordinate(38.8261366, -77.3023501); //potomac height
		}
		else if(this.name.equals("Adams")) {
			this.coord = new Coordinate(38.8295906, -77.3010077); //admas
		}
		else if(this.name.equals("Eisenhower")) {
			this.coord = new Coordinate(38.8288451, -77.3023716); //eisenhower
		}
		else if(this.name.equals("Harrison")) {
			this.coord = new Coordinate(38.8294096, -77.3024775); //harrison
		}
		else if(this.name.equals("Jackson")) {
			this.coord = new Coordinate(38.8286531, -77.301348); //jackson
		}
    ...
    */
   public double timeCalculator(Coordinate lot, Coordinate destination) {
